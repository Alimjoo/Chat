...
const cn = {
  ...
  Chat: {
    ...
    Actions: {
      ...
      Retry: "قايتا سىناش",
      Pin: "قاداش",
      PinToastContent: "بىر سۆھبەتنى ئالدىن بەلگىلەنگەن ئەسكەرتمە سۆزىگە مۇقىملاندى",
    ...
    Send: "يوللاش",
    Config: {
      Reset: "جاتىرىنى تازىلاش",
      SaveAs: "نىقاب قىلىپ ساقلاش",
    },
    IsContext: "ئەسكەرتىش سۆزى قىلىش",
  },
  Export: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle: "ھەر قېتىملىق تەلەپ قىلىش ئۇچۇر جەدۋىلىنىڭ باشلىنىشىغا تەقلىدىي ChatGPT سىستېمىسى ئەسكەرتىشىنى كىرگۈزۈش",
    },
    InputTemplate: {
    ...
    Prompt: {
      Disable: {
        ...
        SubTitle: "كىرگۈزۈش رامكىسىنىڭ بېشىدا /  نى كىرگۈزسە ئاپتوماتىك تاماملاش قوزغىلىدۇ",
      },
    ...
    CompressThreshold: {
      ...
      SubTitle: "قىسقارتىلمىغان تارىخىي خەۋەر بۇ قىممەتتىن ئېشىپ كەتكەندە قىسقارتىش",
    },
    Token: {
      Title: "API Key",
    ...
    Usage: {
      ...
      NoAccess: "API Keyنى كىرگۈزۈش ياكى مەخپىي نومۇرنى تەكشۈرۈپ قالدۇق سوممىسىنى تەشكۈرۈش",
    },
    AccessCode: {
      Title: "مەخپى شىفىر",
    ...
    CustomModel: {
      ...
      SubTitle: "ئۆزى بەلگىلەنگەن مودېلنى كۆپەيتىپ، ئىنگلىزچە پەش بىلەن ئايرىش كېرەك",
    },
    Model: "مودىل (model)",
    Temperature: {
    ...
    TopP: {
      ...
      SubTitle: "ئىختىيارىي خاراكتېرىگە ئوخشاپ كېتىدۇ، لېكىن ئىختىيارىي خاراكتېر بىلەن بىللە ئۆزگەرتمەڭ",
    },
    MaxTokens: {
    ...
    FrequencyPenalty: {
      ...
      SubTitle: "قىممىتى قانچە چوڭ بولسا، تەكرار خەتلىك سۆزنى شۇنچە تۆۋەنلىتىشى مۇمكىن",
    },
  },
  Store: {
    DefaultTopic: "يېڭى دىئ‍الوگ",
    BotHello: "ئۇيغۇرچىنى مۇكەممەل قوللىمايدۇ، ئەڭ ياخشىسى خەنزۇچە ياكى ئىنگىلىزچە سۇئال سوراڭ!!!",
    Error: "خاتالىق چىقتى، سەل تۇرۇپ قايتا سىناپ بېقىڭ",
    Prompt: {
      History: (content: string) => "بۇ سۆھبەت تارىخىنىڭ قىسقىچە مەزمۇنىنى: " + content,
      Topic:
  ...
  Mask: {
    ...
    Config: {
      ...
      Sync: {
        ...
        SubTitle: "نۆۋەتتىكى سۆھبەتتە ئومۇمىي ۋەزىيەت مودېلى ئارقىلىق تەسىس قىلىندىمۇ",
        Confirm: "نۆۋەتتە سۆھبەتنىڭ ئاپتوماتىك ئېنىقلىمىسى ئاپتوماتىك قاپلىنىپ، ئىشلىتىش ئومۇمىيلىقىنى جەزىملەشتۈرەلەمدۇ؟",
      },
      HideContext: {
        Title: "يوشۇرۇن ئالدىن بېكىتىلگەن دىئالوگ",
        SubTitle: "يوشۇرغاندىن كېيىن ئالدىن مۆلچەرلەشكەن سۆھبەت پاراڭلىشىش كۆرۈنمە يۈزىدە كۆرۈلمەيدۇ",
      },
      Share: {
  ...
  NewChat: {
    ...
    ConfirmNoShow: "چەكلەنگەنلىكىنى جەزىملەشتۈرۈش ؟ چەكلەنگەندىن كېيىن ھەرۋاقىت تەسىس قىلىش جەريانىدا قايتىدىن ئىشقا كىرىشتۈرۈلىدۇ.",
    Title: "نىقاب تاللاڭ",
    SubTitle: "ھازىردىن باشلاپ نىقابنىڭ ئارقىسىدىكى روھ تەپەككۇرى بىلەن سوقۇلىدۇ",
    More: "ھەممىنى كۆرۈش",
  },
