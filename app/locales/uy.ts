...
const cn = {
  ...
  Error: {
    ...
    Unauthorized: isApp
      ...
      : "زىيارەت نومۇرىنى خاتا ياكى قۇرۇق. [تەڭشەك](/#/auth) گە كىرىپ توغرا پارولنى كىرگۈزۈڭ! \n   ئەگەر زىيارەت قىلىش نومۇرۇرى بولمىسا، باشقۇرغۇچى بىلەن ئالاقىلىشىڭ:  \n\n **ئۈندىدار**: `PiStallion` \n **چ چ**: `1229866724`",
  },
  Auth: {
